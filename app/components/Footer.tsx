		...
		<>
			<footer className='footer p-10 bg-base-200 text-base-content'>
				...
				<div>
					...
					<a className='link link-hover' href='https://github.com/kodingbooks'>
						Github | Source Code
					</a>

					<br />
					<span className='footer-title'>Contact</span>
					<a className='link link-hover' href='mailto:me@ciderboi.xyz'>
						
					</a>
					<a className='link link-hover' href='mailto:techformersdps@gmail.com'>
						Email (Techformers Club)
					</a>
				</div>
				<div>
